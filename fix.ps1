...
<html>
<head>
    <title>/tmp/files - create-missing-files.ps1</title>

    <meta http-equiv="content-Type" content="text/html; charset=UTF-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">

    <link href='https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500&display=swap' rel='stylesheet'/>
    <link href="/css/style.css?v=6df0641" media="all" rel="stylesheet" type="text/css"/>
...
<div id="container">
    ...
    <div class="show-content">
        <h2 class="file-title">create-missing-files.ps1</h2>

                    
            <p><a class="download" href="https://tmpfiles.org/dl/1786119000.a6291e068ad8a92c/w1wzFpIeKHpE/create-missing-files.ps1">Download (15.03 KB)</a></p>
